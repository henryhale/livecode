...
};`,v.contentWindow.__$fn_.call()}))}function se(o){f.body&&(f.body.innerHTML=o)}function ie(o){if(!f)return;let e=f.querySelector("style#xtag");e||(e=document.createElement("style"),e.id="xtag",f.head.appendChild(e)),e.innerHTML=o}const ce="livecode-backup",g=new M(new H(ce));function ae(){return g.read(),g.data}function N(o){g.data=o,g.write()}const le={"index.html":`<div id="app">
  <h1>Hello, World!</h1>
