...
export function generatePageContent({html, css, js}) {
    return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Document</title><style type="text/css">${css}</style></head><body>${html}<script type="module">${js}</` + `script></body></html>`
}
